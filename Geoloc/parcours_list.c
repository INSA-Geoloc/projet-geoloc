...
/*
* @brief Fonction utilis� pour essayer de parser le fichier csv.�
*/
...
/*@brief 
* Fonction de nettoyage de la trame.
...
void cleanRedundantPoints()
{
  ...
  {
    suiv = listTemp->next;
    if (fabs(listTemp->pt->longitude - suiv->pt->longitude) < 30 && fabs(listTemp->pt->latitude - suiv->pt->latitude) < 30 && strcmp(listTemp->pt->adresse, "INTERET") != 0)
    {
      if (previous != NULL)
      { // First point
...
/**
* @brief Converti la liste original des donn�es, de GPS � Lambert93��
*
*/
